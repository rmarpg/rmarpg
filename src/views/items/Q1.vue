...
<template>
  <RMALayout>
    <div class="flex flex-col items-center py-4 sm:justify-center sm:py-8">
      <div class="mb-4 w-full max-w-sm sm:mb-8">
        <div class="mb-2 flex items-center justify-between text-white">
          <span class="text-lg font-medium">1/2</span>
          <span class="font-mono text-lg">{{ formatTime(timeLeft) }}</span>
        </div>

        <p class="text-sm text-white">Task 0: Addition</p>
      </div>

      <div class="mb-6 min-w-[200px] rounded-lg bg-white p-8 text-center">
        <div class="mb-4 flex justify-center">
          <div class="w-32">
            <div class="mb-2 text-right text-4xl font-bold text-gray-800">15</div>
